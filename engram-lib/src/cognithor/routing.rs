...
pub fn analyze_query(query: &str) -> RoutingDecision {
    ...
    let code_score: f64 = code_indicators
        .iter()
...
fn detect_language(query: &str) -> Option<String> {
    ...
    let patterns: &[(&str, &[&str])] = &[
        (
            "rust",
            &[
                "rust", "cargo", "crate", "impl ", "fn ", "pub fn", "::new(", "unwrap",
            ],
        ),
        (
            "python",
            &[
                "python", "pip", "django", "flask", "def ", "import ", "self.",
            ],
        ),
        (
            "javascript",
            &["javascript", "npm", "node", "react", "const ", "let ", "=>"],
        ),
        (
            "typescript",
            &[
        ...
        (
            "java",
            &["java", "maven", "gradle", "public class", "spring"],
        ),
    ];
